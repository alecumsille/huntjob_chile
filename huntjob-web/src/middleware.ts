...
function isAiRoute(pathname: string): boolean {
  return pathname.startsWith('/api/chat') || pathname.startsWith('/api/apply') || pathname.startsWith('/api/cv/parse') || pathname.startsWith('/api/cv/improve') || pathname.startsWith('/api/evaluate');
}
